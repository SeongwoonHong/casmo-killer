...
class UserInfo extends Component {
  ...
  componentDidMount() {
    ...
    const loadUntilScrollable = () => {
      ...
      if ((document.getElementsByClassName('component-row')[0].offsetHeight) < window.innerHeight) {
    ...
    document.getElementsByClassName('app-container')[0].addEventListener('scroll', () => {
      ...
      if ((document.getElementsByClassName('aapp-container')[0].scrollTop) + 100 >= (document.getElementsByClassName('component-row')[0].offsetHeight - window.innerHeight)) {
